...
namespace DirectOutput.Cab.Out.AdressableLedStrip
{
    ...
    public class UMXSerialControllerAutoConfigurator : IAutoConfigOutputController
    {
        ...
        static UMXSerialControllerAutoConfigurator()
        {
            //FindDevices();
        }
        ...
        private static void FindDevices()
        {
            ...
            foreach(var device in devices) {
                UMXControllerAutoConfigurator.AddUMXDevice(device);
            }
        }
