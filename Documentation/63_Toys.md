...
\section use_DirectOutput_Cab_Toys_Generic_GenericDigitalToy GenericDigitalToy

\subsection use_DirectOutput_Cab_Toys_Generic_GenericDigitalToy_summary Summary
...
\subsection use_DirectOutput_Cab_Toys_Generic_GenericDigitalToy_samplexml Sample XML

A configuration section for GenericDigitalToy might resemble the following structure:

~~~~~~~~~~~~~{.xml}
<GenericDigitalToy>
  <Name>Name of GenericDigitalToy</Name>
  <OutputName>Name of Output</OutputName>
</GenericDigitalToy>
~~~~~~~~~~~~~
\subsection use_DirectOutput_Cab_Toys_Generic_GenericDigitalToy_properties Properties

GenericDigitalToy has the following 2 configurable properties:

\subsubsection DirectOutput_Cab_Toys_Generic_GenericDigitalToy_OutputName OutputName

Name of the Output for the GenericDigitalToy



\subsubsection DirectOutput_Cab_Toys_Generic_GenericDigitalToy_Name Name
...
\section use_DirectOutput_Cab_Toys_Generic_GenericAnalogToy GenericAnalogToy

\subsection use_DirectOutput_Cab_Toys_Generic_GenericAnalogToy_summary Summary
...
\subsection use_DirectOutput_Cab_Toys_Generic_GenericAnalogToy_samplexml Sample XML

A configuration section for GenericAnalogToy might resemble the following structure:

~~~~~~~~~~~~~{.xml}
<GenericAnalogToy>
  <Name>Name of GenericAnalogToy</Name>
  <OutputName>Name of Output</OutputName>
</GenericAnalogToy>
~~~~~~~~~~~~~
\subsection use_DirectOutput_Cab_Toys_Generic_GenericAnalogToy_properties Properties

GenericAnalogToy has the following 2 configurable properties:

\subsubsection DirectOutput_Cab_Toys_Generic_GenericAnalogToy_OutputName OutputName

Name of the Output for the GenericAnalogToy.



\subsubsection DirectOutput_Cab_Toys_Generic_GenericAnalogToy_Name Name
...
Lamp toy.<br />
Inherits from <see cref="T:DirectOutput.Cab.Toys.Generic.GenericAnalogToy" />, implements <see cref="T:DirectOutput.Cab.Toys.IToy" />.
...
\section use_DirectOutput_Cab_Toys_Layer_AnalogToy AnalogToy

\subsection use_DirectOutput_Cab_Toys_Layer_AnalogToy_summary Summary
...
\subsection use_DirectOutput_Cab_Toys_Layer_AnalogToy_properties Properties

AnalogToy has the following 2 configurable properties:

\subsubsection DirectOutput_Cab_Toys_Layer_AnalogToy_OutputName OutputName
...
\subsubsection DirectOutput_Cab_Toys_Layer_AnalogToy_Name Name
